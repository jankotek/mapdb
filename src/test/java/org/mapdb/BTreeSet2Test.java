...
//
    ...
    private NavigableSet<Integer> populatedSet(int n) {
        NavigableSet<Integer> q = DBMaker.memoryDB().transactionDisable().make().getTreeSet("test");
    ...
    public void testConstructor1() {
        assertEquals(0, DBMaker.memoryDB().transactionDisable().make().getTreeSet("test").size());
    }
...
//    }
    ...
    public void testConstructor7() {
        ...
        NavigableSet q =
                DBMaker.memoryDB().transactionDisable().make().createTreeSet("test").comparator(cmp).make();
...
//    }
    ...
    public void testAddAll_idempotent() throws Exception {
        ...
        Set y = DBMaker.memoryDB().transactionDisable().make().getTreeSet("test");
        y.addAll(x);
        assertEquals(x, y);
        assertEquals(y, x);
    }
    ...
    static NavigableSet<Integer> newSet(Class cl) throws Exception {
        NavigableSet<Integer> result = DBMaker.memoryDB().transactionDisable().make().getTreeSet("test");
