...
public abstract class ConcurrentMapInterfaceTest<K, V>
  ...
  @Test public void testPutIfAbsentNewKey() {
  ...
  @Test public void testPutIfAbsentExistingKey() {
    final ConcurrentMap<K, V> map;
    final K keyToPut;
    final V valueToPut;
    try {
  ...
  @Test public void testPutIfAbsentNullKey() {
    if (allowsNullKeys) {
  ...
  @Test public void testPutIfAbsentNewKeyNullValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testPutIfAbsentExistingKeyNullValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testRemoveKeyValueExisting() {
    final ConcurrentMap<K, V> map;
    final K keyToRemove;
    try {
      map = makePopulatedMap();
  ...
  @Test public void testRemoveKeyValueMissingKey() {
    final ConcurrentMap<K, V> map;
    final K keyToRemove;
  ...
  @Test public void testRemoveKeyValueDifferentValue() {
    final ConcurrentMap<K, V> map;
    final K keyToRemove;
    final V valueToRemove;
    try {
  ...
  @Test public void testRemoveKeyValueNullKey() {
    if (allowsNullKeys) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testRemoveKeyValueExistingKeyNullValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace2ExistingKey() {
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace2MissingKey() {
    final ConcurrentMap<K, V> map;
    final K keyToReplace;
    final V newValue;
    try {
  ...
  @Test public void testReplace2NullKey() {
    if (allowsNullKeys) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace2ExistingKeyNullValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace2MissingKeyNullValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace3ExistingKeyValue() {
    final ConcurrentMap<K, V> map;
    final K keyToReplace;
    final V oldValue;
    final V newValue;
  ...
  @Test public void testReplace3ExistingKeyDifferentValue() {
    final ConcurrentMap<K, V> map;
    final K keyToReplace;
    final V oldValue;
    final V newValue;
  ...
  @Test public void testReplace3MissingKey() {
    final ConcurrentMap<K, V> map;
    final K keyToReplace;
    final V oldValue;
    final V newValue;
  ...
  @Test public void testReplace3NullKey() {
    if (allowsNullKeys) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
  ...
  @Test public void testReplace3MissingKeyNullOldValue() {
    if (allowsNullValues) {
      return;   // Not yet implemented
    }
    final ConcurrentMap<K, V> map;
