...
public class HTreeSetTest{
    ...
    @Test public void test_Constructor() {
        ...
        Set hs2 = new HTreeMap(engine, 0,0,HTreeMap.preallocateSegments(engine),Serializer.BASIC_SERIALIZER,null,0,0,0,0,null,null).keySet();
    ...
    @Test public void test_isEmpty() {
        ...
        assertTrue("Empty set returned false", new HTreeMap(engine, 0,0,HTreeMap.preallocateSegments(engine),Serializer.BASIC_SERIALIZER,null,0,0,0,0,null,null).keySet().isEmpty());
    ...
    @Before public void setUp() throws Exception {
        hs = new HTreeMap(engine, 0,0,HTreeMap.preallocateSegments(engine),Serializer.BASIC_SERIALIZER,null,0,0,0,0,null,null).keySet();
