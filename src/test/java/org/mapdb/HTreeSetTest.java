...
public class HTreeSetTest{
    ...
    @Test public void test_isEmpty() {
        ...
        assertTrue("Empty set returned false", new HTreeMap(engine, 0,0,HTreeMap.preallocateSegments(engine),Serializer.BASIC,null,0,0,0,0,0,null,null,null,null,false,null).keySet().isEmpty());
