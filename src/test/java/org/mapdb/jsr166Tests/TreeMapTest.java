...
abstract class TreeMapTest extends JSR166TestCase {

    /**
     * Returns a new map from Integers 1-5 to Strings "A"-"E".
     */
    protected NavigableMap map5() {
        NavigableMap map = emptyMap();
    ...
    @NotNull
    abstract NavigableMap emptyMap();

    abstract NavigableMap fromSorted(NavigableMap map);
    ...
    public void testConstructFromSorted() {
        NavigableMap map = map5();
        NavigableMap map2 = fromSorted(map);
