...
public class BTreeMap<K,V> extends AbstractMap<K,V>
    ...
    public abstract static class BNode{
        ...
        public final int findChildren(final Comparator comparator,final Object key) {
            ...
            int right =isRightEdge() ? keys.length-1 :  keys.length;
    ...
    protected static final class NodeSerializer<A,B> implements  Serializer<BNode>{
        ...
        public void serialize(DataOutput out, BNode value) throws IOException {
            ...
            keySerializer.serialize(out,left?1:0,
                    right?value.keysLen()-1:value.keysLen(),
                    value.keys());
        ...
        while(true){
            ...
            do{
                ...
                if(pos<A.keysLen()-1 &&  v!=null && A.key(pos)!=null && //TODO A.key(pos]!=null??
                        0==comparator.compare(v,A.key(pos))){
            ...
            if(A.keysLen() - (A.isLeaf()?2:1)<maxNodeSize){
                ...
                if((current != rootRecid)){ //is not root
                    ...
                    BNode R = new DirNode(
                            new Object[]{A.key(0), A.highKey(), B.isLeaf()?null:B.highKey()},
                            true,true,false,
    ...
    private V remove2(final Object key, final Object value) {
        ...
        while(true){
            ...
            if(pos<A.keysLen()&& key!=null && A.key(pos)!=null && //TODO A.key(pos]!=null??
                    0==comparator.compare(key,A.key(pos))){
