 ...
 * <p/>
 * This class used {@link java.lang.System#identityHashCode(Object)} instead of {@link Object#hashCode()}
 * <p/>
 * It was  taken from Apache Harmony (WeakHashMap) and modified for MapDB purposes.
 *
 * @see HashMap
 * @see WeakReference
 */
public class WeakIdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V> {
    ...
    transient volatile Collection<V> valuesCollection = null;
    ...
    public V put(K key, V value) {
        ...
        if (entry == null) {
            ...
            if (++elementCount > threshold) {
                rehash();
                index = key == null ? 0 : (System.identityHashCode(key) & 0x7FFFFFFF)
                        % elementData.length;
            }
